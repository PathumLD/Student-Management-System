...
public class updatesubject extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update and Delete Subject");
        ...
        jLabel4.setText("Subject Teacher");

        jTextField3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N

        jLabel5.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
        jLabel5.setText("Number of Topics");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            ResultSet rs=st.executeQuery("select * from subject where id = '"+id+"'");
            while(rs.next())
            {
                checkid = 1;
            ...
            if(checkid == 0){
                JOptionPane.showMessageDialog(null, "Subject ID does not Exist");
            }
        }
        catch(Exception e)
        {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String teacher=jTextField3.getText();
        String topics=jTextField4.getText();

        try
        {
            Connection con=ConnectionProvider.getcon();
            PreparedStatement ps=con.prepareStatement("update subject set name=?,teacher=?,topics=? where id=?");
            ps.setString(1, name);
            ps.setString(2, teacher);
            ps.setString(3, topics);
            ps.setString(4, id);
            ps.executeUpdate();
